<div class="box_page">
    ...
    <?php if ( ! $is_edit ) : ?>
        <p>
            <input type="submit" name="save_pages_add" id="save" value="<?php _e( 'Create New', 'boss' ); ?>"/>
        </p>
    <?php else: ?>
        <input type="hidden" name="extra-page-id" value="<?php echo (int) $page->ID; ?>"/>
        <p>
            <input type="submit" name="save_pages_edit" id="save" value="<?php echo __( 'Save Changes', 'boss' ); ?>"/>
        </p>
    <?php endif; ?>
