<div class="box_field">
	...
	<input type="radio" value="req" <?php checked( $field->pinged, 'req' ); ?>
		   name="extra-field-required"> <span><?php _e( 'Required', 'buddypress-groups-extras' ); ?></span><br/>
	<input type="radio" value="not_req" <?php checked( $field->pinged, 'not_req' ); ?>
		   name="extra-field-required"> <span><?php _e( 'Not Required', 'buddypress-groups-extras' ); ?></span>
	<br/>
	...
	<input type="radio" name="extra-field-display"
		   value="publish" <?php checked( $field->post_status, 'publish' ); ?>><span><?php _e( 'Display it', 'buddypress-groups-extras' ); ?></span>
	<br/>
	<input type="radio" name="extra-field-display"
		   value="draft" <?php checked( $field->post_status, 'draft' ); ?>><span><?php _e( 'Do NOT display it', 'buddypress-groups-extras' ); ?></span>
