    ...
    foreach($pages as $page){
        echo '<li id="position_'.$page->ID.'" class="default">
                ...
                <span class="items-link">
                    ...
                    <a href="' . bp_get_group_permalink( $bp->groups->current_group ) . 'admin/'.$slug . '/pages-manage/?edit=' . $page->ID . '" class="button bb-edit-button" title="'.__('Change its title, content etc','bpge').'"><i class="fas fa-pencil-alt"></i></a>&nbsp;
